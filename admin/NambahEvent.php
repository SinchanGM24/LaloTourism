...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nama && $deskripsi && $media) {
        if ($op == 'edit') { //untuk update
            $sql1 = "UPDATE event SET nama_event='$nama', deskripsi_event='$deskripsi', media_event='$media' WHERE id='$id'";
            ...
            $sql1 = "INSERT INTO event (nama_event, deskripsi_event, media_event) VALUES ('$nama', '$deskripsi', '$media')";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama" name="nama_event" value="">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="deskripsi" name="deskripsi_event" value="">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="media" class="col-sm-2 col-form-label">Media</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="media" name="media_event">
                                    </div>
                                </div>
                        </div>
                        <div class="col-12">
