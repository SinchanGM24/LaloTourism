...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nama && $deskripsi && $media) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update kuliner set nama_kuliner='$nama',deskripsi_kuliner = '$deskripsi',media_kuliner='$media' where id = '$id'";
            ...
            $sql1   = "insert into kuliner(nama_kuliner,deskripsi_kuliner,media_kuliner) values ('$nama','$deskripsi','$media')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama" name="nama_kuliner" value="">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="deskripsi" name="deskripsi_kuliner" value="">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="media" class="col-sm-2 col-form-label">Media</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="media" name="media_kuliner">
                                    </div>
                                </div>
