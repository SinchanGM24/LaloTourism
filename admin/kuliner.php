...
if ($op == 'delete') {
    if (isset($_GET['id_kuliner'])) {
        $id = $_GET['id_kuliner'];
        $sql12 = "DELETE FROM kuliner WHERE id_kuliner = '$id'";
        ...
        $error = "ID kuliner tidak ditemukan";
    }
}

if ($op == 'edit' && isset($_GET['id_kuliner'])) {
    $id = $_GET['id_kuliner'];
    $sql2 = "SELECT * FROM kuliner WHERE id_kuliner = '$id'";
    $q2 = $koneksi->query($sql2);
    if ($q2 && $q2->num_rows > 0) {
        $r1 = $q2->fetch_assoc();
        $nama = $r1['nama_kuliner'];
        $deskripsi = $r1['deskripsi_kuliner'];
        $media = $r1['media_kuliner'];
    } else {
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    // Process file upload
    if (isset($_FILES['media_kuliner']) && $_FILES['media_kuliner']['error'] == 0) {
        $targetDir = "../asset/"; // Tentukan direktori penyimpanan file
        $fileName = basename($_FILES["media_kuliner"]["name"]);
        ...
        if (in_array($fileType, $allowTypes)) {
            ...
            if (move_uploaded_file($_FILES["media_kuliner"]["tmp_name"], $targetFilePath)) {
    ...
    if ( $nama && $deskripsi && $media) {
        if ($op == 'edit') { //untuk update
            $sql2       = "UPDATE kuliner set nama_kuliner ='$nama', deskripsi_kuliner = '$deskripsi', media_kuliner='$media' where id_kuliner = '$id'";
            $q2 = $koneksi->query($sql2);
            if ($q2) {
            ...
            $sql2   = "INSERT INTO kuliner(nama_kuliner,deskripsi_kuliner,media_kuliner) values ('$nama','$deskripsi','$media')";
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="kuliner.php">Kuliner</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="mx-auto">
                        <a href="NambahKuliner.php"><button type="button" class="tambahkan">Tambahkan</button></a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            while ($r2 = mysqli_fetch_array($q2)) {
                                                ...
                                                $deskripsi = $r2['deskripsi_kuliner'];
                                                $media = $r2['media_kuliner']; // Mendapatkan nama file dari path
                                            ?>
                                                <tr>
                                                    <td><?php echo $urut++ ?></td>
                                                    <td><?php echo $nama ?></td>
                                                    ...
                                                    <td>
                                                        <a href="kuliner.php?op=edit&id_kuliner=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                        <a href="kuliner.php?op=delete&id_kuliner=<?php echo $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
                        ...
                        <div class="card-body ">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama" name="nama_kuliner" value="<?php echo $nama ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="deskripsi" name="deskripsi_kuliner" value="<?php echo $deskripsi ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="media" class="col-sm-2 col-form-label">Media</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="media" name="media_kuliner" value="<?php echo $media ?>" >
                                    </div>
                                </div>
