...
if ($op == 'delete') {
    if (isset($_GET['id_souvenir'])) {
        $id = $_GET['id_souvenir'];
        $sql12 = "DELETE FROM souvenir WHERE id_souvenir = '$id'";
        ...
        $error = "ID souvenir tidak ditemukan";
    }
}

if ($op == 'edit' && isset($_GET['id_souvenir'])) {
    $id = $_GET['id_souvenir'];
    $sql2 = "SELECT * FROM souvenir WHERE id_souvenir = '$id'";
    $q2 = $koneksi->query($sql2);
    if ($q2 && $q2->num_rows > 0) {
        $r1 = $q2->fetch_assoc();
        $nama = $r1['nama_souvenir'];
        $deskripsi = $r1['deskripsi_souvenir'];
        $media = $r1['media_souvenir'];
    } else {
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    $deskripsi  = $_POST['deskripsi_souvenir'];

    // Process file upload
    if (isset($_FILES['media_souvenir']) && $_FILES['media_souvenir']['error'] == 0) {
        $targetDir = "../asset/"; // Tentukan direktori penyimpanan file
        $fileName = basename($_FILES["media_souvenir"]["name"]);
        ...
        if (in_array($fileType, $allowTypes)) {
            ...
            if (move_uploaded_file($_FILES["media_souvenir"]["tmp_name"], $targetFilePath)) {
    ...
    if ( $nama && $deskripsi && $media) {
        if ($op == 'edit') { //untuk update
            $sql2       = "UPDATE souvenir set nama_souvenir='$nama', deskripsi_souvenir = '$deskripsi', media_souvenir='$media' where id_souvenir = '$id'";
            $q2 = $koneksi->query($sql2);
            if ($q2) {
            ...
            $sql2   = "INSERT INTO souvenir(nama_souvenir,deskripsi_souvenir,media_souvenir) values ('$nama','$deskripsi','$media')";
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="souvenir.php">Souvenir</a>
                    </div>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="mx-auto">
                        <a href="NambahSouvenir.php"><button type="button" class="tambahkan">Tambahkan</button></a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            while ($r2 = mysqli_fetch_array($q2)) {
                                                $id = $r2['id_souvenir'];
                                                $nama = $r2['nama_souvenir'];
                                                $deskripsi = $r2['deskripsi_souvenir'];
                                                $media = $r2['media_souvenir'];
                                            ?>
                                                <tr>
                                                    <td><?php echo $urut++ ?></td>
                                                    <td><?php echo $nama ?></td>
                                                    ...
                                                    <td>
                                                        <a href="souvenir.php?op=edit&id_souvenir=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                        <a href="souvenir.php?op=delete&id_souvenir=<?php echo $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
                        ...
                        <div class="card-body ">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama" name="nama_souvenir" value="<?php echo $nama ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="deskripsi" name="deskripsi_souvenir" value="<?php echo $deskripsi ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="media" class="col-sm-2 col-form-label">Media</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="media" name="media_souvenir" value="<?php echo $media ?>" >
                                    </div>
                                </div>
